import unittest
from app.Stringtonum import StringNumValue
...
class TestStringNumValue(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        every time.
        """
        self.uut = StringNumValue('0')
        self.alphabet = StringNumValue('a')
    ...
    def test_empty_string_has_value_zero(self):
        self.assertEqual(0, self.uut.letter_to_position())
    ...
    #     self.assertEqual(9, self.uut.letter)
    #
    ...
    #     self.assertEqual(1, self.uut.letter_to_position())
    # #
